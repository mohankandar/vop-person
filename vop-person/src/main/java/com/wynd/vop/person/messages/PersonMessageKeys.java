package com.wynd.vop.person.messages;
...
public enum PersonMessageKeys implements MessageKey {
   ...
   */
  VOP_SAMPLE_REQUEST_PID_INCONSISTENT("vop.person.sample.request.pid.inconsistent",
      "Response returned an invalid Participant ID."),
  /**
   * Response has different PID than the logged in user; no args
   */
  VOP_SAMPLE_REQUEST_PID_INVALID("vop.person.sample.request.pid.invalid",
      "Response has different PID than the logged in user."),
  VOP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_MOCK_DATA("vop.person.sample.service.impl.responded.with.mock.data",
